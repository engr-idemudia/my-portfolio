...
// Without this guard, a browser with WebGL disabled lets the globe retry
// context creation in a tight loop, spiking the CPU and fans.
...
// Minimal, non-interactive stand-in shown when WebGL is unavailable or the
// 3D globe fails to render. Pure CSS, no images or dependencies.
  ...
  <div className="flex h-full w-full items-center justify-center">
    <div
      ...
      style={{
        ...
        borderRadius: "9999px",
        background:
          "radial-gradient(circle at 35% 30%, rgba(203,172,249,0.35), rgba(61,43,143,0.28) 45%, rgba(10,4,30,0.9) 80%)",
...
// Catches any runtime error thrown while rendering the globe and shows the
// static fallback instead of letting the page break.
...
const GridGlobe = () => {
  // Detect WebGL after hydration: the server renders the fallback, then the
  // client swaps in the globe if WebGL is available. Hydration-safe, and with
